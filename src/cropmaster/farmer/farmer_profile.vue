    ...
    <div class="background">
        <div class="content-container">
            <div class="text-container">
                ...
                <div style="display: flex; justify-content: space-between; margin: 1.2rem 0 1.2rem 0">
                    <p>Hola, soy Huell y amo las lechugas. Estoy emocionado de unirme a cropmaster para aprender y compartir sobre el cultivo de lechugas. ¡Juntos cultivaremos de manera más inteligente y saludable!</p>
                </div>
